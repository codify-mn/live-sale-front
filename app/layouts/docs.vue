...
<template>
  <div class="min-h-screen bg-white dark:bg-gray-950">
    <!-- Top Navigation -->
    <header class="sticky top-0 z-50 backdrop-blur-xl bg-white/80 dark:bg-gray-950/80 border-b border-gray-200 dark:border-gray-800">
        ...
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center gap-4">
            ...
            <NuxtLink to="/" class="flex items-center gap-2.5">
              <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-primary-500 to-pink-500 flex items-center justify-center">
            ...
            <span class="text-sm font-medium text-gray-600 dark:text-gray-400 hidden sm:block">
              Баримтжуулалт
            </span>
          </div>
    ...
    <div class="max-w-[90rem] mx-auto flex">
      ...
      >
        ...
        <nav class="bg-white dark:bg-gray-950 lg:bg-transparent h-full p-6 border-r border-gray-200 dark:border-gray-800 lg:border-0">
          <!-- Quick links -->
          <div class="mb-8">
          ...
          <UContentNavigation
            ...
            :ui="{
              ...
              linkActive: 'bg-primary-50 dark:bg-primary-950/50 text-primary-600 dark:text-primary-400 font-medium'
            }"
          />
        </nav>
      </aside>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
          <div class="flex items-center gap-4">
            <NuxtLink to="/" class="flex items-center gap-2">
              <div class="w-7 h-7 rounded-lg bg-gradient-to-br from-primary-500 to-pink-500 flex items-center justify-center">
                <UIcon name="i-lucide-zap" class="w-3.5 h-3.5 text-white" />
              </div>
              <span class="font-semibold text-sm text-gray-900 dark:text-white">CommentBoost</span>
            </NuxtLink>
          ...
          <div class="flex items-center gap-6 text-sm">
            <NuxtLink to="/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">
              Нүүр хуудас
            </NuxtLink>
            <NuxtLink to="/pricing" class="text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">
              Үнийн мэдээлэл
            </NuxtLink>
