...
const paymentMethods = [
  { label: 'Бэлэн мөнгө', value: 'cash', icon: 'i-lucide-banknote', description: 'Бэлнээр төлбөр хүлээн авна' },
  { label: 'Банкны шилжүүлэг', value: 'bank_transfer', icon: 'i-lucide-landmark', description: 'Дансаар шилжүүлэх' },
  { label: 'QPay', value: 'qpay', icon: 'i-lucide-smartphone', description: 'QPay-ээр төлбөр хүлээн авна' }
]
...
<template>
  <div class="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
    ...
    <div class="relative w-full max-w-lg">
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between relative">
          ...
          <div class="absolute top-5 left-0 right-0 h-0.5 bg-gray-200 dark:bg-gray-800 mx-10" />
          <!-- Progress line active -->
          <div
            class="absolute top-5 left-0 h-0.5 bg-primary-500 mx-10 transition-all duration-500 ease-out"
          ...
          >
            ...
            <span
              ...
              :class="currentStep >= step.number ? 'text-primary-600 dark:text-primary-400' : 'text-gray-400 dark:text-gray-500'"
            >
              {{ step.label }}
            </span>
          </div>
      ...
      <!-- Glass card -->
      <div class="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-gray-700/30 shadow-xl shadow-gray-200/50 dark:shadow-gray-950/50 overflow-hidden">
        <!-- Header -->
        <div class="px-8 pt-8 pb-4">
          <Transition :name="slideDirection === 'left' ? 'slide-left' : 'slide-right'" mode="out-in">
            <div v-if="currentStep === 1" key="header-1" class="text-center">
              ...
              <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Дэлгүүрээ үүсгээрэй</h1>
            ...
            <div v-else-if="currentStep === 2" key="header-2" class="text-center">
              <div class="w-14 h-14 rounded-2xl bg-primary-50 dark:bg-primary-900/20 flex items-center justify-center mx-auto mb-4">
                <UIcon name="i-lucide-credit-card" class="w-7 h-7 text-primary-500" />
              </div>
              <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Төлбөрийн мэдээлэл</h1>
              <p class="text-gray-500 dark:text-gray-400 mt-2 text-sm">
                Хэрхэн төлбөр хүлээн авахаа сонгоно уу
              </p>
            </div>

            <div v-else key="header-3" class="text-center">
              <div class="w-14 h-14 rounded-2xl bg-primary-50 dark:bg-primary-900/20 flex items-center justify-center mx-auto mb-4">
                <UIcon name="i-lucide-truck" class="w-7 h-7 text-primary-500" />
              </div>
              <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Хүргэлтийн тохиргоо</h1>
              <p class="text-gray-500 dark:text-gray-400 mt-2 text-sm">
                ...
                <div class="space-y-2">
                  ...
                  >
                    ...
                    <div
                      ...
                      :class="state.payment_method === method.value
                    ...
                    <div class="flex-1 min-w-0">
                      <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ method.label }}</p>
