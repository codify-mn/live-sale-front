...
onMounted(async () => {
  ...
  if (shop.value) {
    ...
    state.allow_overselling = shop.value.settings?.allow_overselling || false
  }
})
...
async function saveSettings() {
  const updates = {
    ...
    settings: {
      ...
      allow_overselling: state.allow_overselling
    }
  }
  ...
  <div>
    ...
    <UPageCard variant="subtle" class="mb-8">
      ...
      <template v-if="showBankFields">
        ...
        <UFormField
          ...
          class="flex max-sm:flex-col justify-between items-start gap-4"
        >
          <USelect v-model="state.bank_name" :items="banks" placeholder="Банк сонгох" />
        </UFormField>
        <USeparator />
        <UFormField
    ...
    <UPageCard variant="subtle" class="mb-8">
      ...
      <UFormField
        ...
        class="flex max-sm:flex-col justify-between items-start gap-4"
      >
        <UInput v-model.number="state.free_delivery_over" type="number" autocomplete="off">
          <template #trailing>
            <span class="text-muted text-xs">₮</span>
          </template>
        </UInput>
    ...
    <UPageCard
      ...
      description="Бүтээгдэхүүний үлдэгдлийн удирдлага."
      variant="naked"
      class="mb-4"
    />
    ...
    <UPageCard variant="subtle">
      <UFormField
        ...
        label="Үлдэгдэлгүй үед зарах"
        description="Бүтээгдэхүүний үлдэгдэл дуусахаас өмнө захиалга авах боломжтой."
        class="flex items-center justify-between gap-2"
      >
        <USwitch v-model="state.allow_overselling" />
      </UFormField>
    </UPageCard>
    </UForm>
  </div>
