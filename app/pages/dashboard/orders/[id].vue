...
useSeoMeta({
  title: () =>
    order.value ? `Захиалга #${order.value.order_number} - Comment Boost` : 'Захиалга - Comment Boost'
})
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
              ...
              <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
                ...
                >
                  ...
                  <span class="text-gray-900 dark:text-white">{{ formatPrice(order.shipping_fee) }}</span>
                </div>
                <div class="flex justify-between text-base font-semibold pt-2 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <span class="text-primary-600 dark:text-primary-400">{{ formatPrice(order.total_amount) }}</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <p
                      v-if="order.customer.city || order.customer.district"
                      class="text-sm text-gray-500 dark:text-gray-400"
                    >
            ...
            >
              ...
              <div class="flex items-center gap-3">
                <UIcon
                  ...
                  class="w-5 h-5 text-gray-500"
                />
                <span class="text-gray-900 dark:text-white">{{ order.metadata.tracking_number }}</span>
              </div>
            </div>
      ...
      <UModal v-model:open="cancelModalOpen">
        <template #content>
          <UCard>
            ...
            <p>
              <strong>#{{ order?.order_number }}</strong> захиалгыг цуцлахдаа итгэлтэй байна уу?
            </p>
