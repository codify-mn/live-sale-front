                            ...
                            <div class="lg:col-span-2 space-y-6">
                                ...
                                >
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <UFormField label="Утас" name="customer_phone" required>
                                            <UInput
                                        ...
                                        <UFormField label="Дүүрэг/Сум" name="customer_district">
                                            <UInput
                            ...
                            <div class="space-y-6">
                                ...
                                >
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <label
                                                class="text-sm text-gray-600 dark:text-gray-400 mb-1 block"
                                            >
                                                Хүргэлтийн төлбөр
                                            </label>
                                            <UInput
