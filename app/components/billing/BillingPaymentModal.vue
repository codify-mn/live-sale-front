        ...
        <template #header>
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              >
                <UIcon name="i-lucide-credit-card" class="w-5 h-5 text-primary-600 dark:text-primary-400" />
              </div>
              <div>
                <h3 class="font-semibold text-gray-900 dark:text-white">Багц худалдан авах</h3>
                <p v-if="invoice?.plan" class="text-sm text-gray-500">{{ invoice.plan.name }}</p>
              </div>
            </div>
          ...
          >
            <div class="flex items-center gap-2">
              <UIcon
                ...
                class="w-4 h-4"
                :class="invoice.status === 'paid' ? 'text-green-600' : 'text-amber-600'"
              />
              <span
                class="text-sm"
                :class="
