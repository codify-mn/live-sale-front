...
<template>
  <div class="space-y-4">
    ...
    <div v-if="accounts.length === 0" class="text-center py-6 border-2 border-dashed rounded-lg">
    ...
    <div v-for="(account, index) in accounts" :key="index" class="border rounded-lg p-4 space-y-3">
      <div class="flex items-center justify-between">
