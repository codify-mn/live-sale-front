    ...
    >
      ...
      <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
        ...
        >
          ...
          <span class="text-gray-900 dark:text-white">{{ formatPrice(shippingFee) }}</span>
        </div>
        <div class="flex justify-between text-base font-semibold pt-2 border-t border-gray-200 dark:border-gray-700">
          ...
          <span class="text-primary-600 dark:text-primary-400">{{ formatPrice(total) }}</span>
        </div>
      </div>
    </div>
  </div>
